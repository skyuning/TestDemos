package me.skyun.test.LifeCircleDemo;
 ...
 */
public class LifeCircleDemoActivity2 extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.go).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LifeCircleDemoActivity2.this, LifeCircleDemoActivity2.class));
            }
        });
    }
